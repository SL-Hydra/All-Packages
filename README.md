<h1><p align= "center">~All-Packages~</p></h1>
<h3><p align= "center">The Easiest Way To Install All Termux Packages🤗</p></h3><br>
...
```git clone https://github.com/SL-Hydra/All-Packages.git```
